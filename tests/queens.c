...
static int user_scbm(int pred, int arity, int clause, int arglist, int rest, int th){
void *next;
int arg1,arg2,arg3,arg4,arg5,aeg6,arg7,arg8,arg9,arg10,subr_number,pointer,ano_1,varA,varData,varH,varHistory,varL,varL1,varM,varOut,varQ,varR,varT,varX;
...
Jpush_back(&&test_0_1,arglist,np[Jget_scp(CONJ,th)][th],th);
goto test_0_0_0join;
test_0_0_0back:
pointer = next_stack1[np[Jget_scp(CONJ,th)][th]+1][th];
varX = Jnth(pointer,1);
test_0_0_0join:
pointer = Jcons(varX,NIL);
Jpush_next(&&test_0_0_1,pointer,th);
...
Jpush_back(&&test_0_0_0back,arglist,np[Jget_scp(CONJ,th)][th],th);
pointer = Jcons(varX,NIL);
Jpush_next(&&test_0_0_2,pointer,th);
subr_number = 1204;
goto builtin_call;
test_0_0_2:
pointer = next_stack1[np[Jget_scp(CONJ,th)][th]+1][th];
...
arglist = NIL;
pointer = Jcons(varX,NIL);
Jpush_next(&&test_0_0_3,pointer,th);
subr_number = 808;
goto builtin_call;
test_0_0_3:
goto allfail;
...
test1_0_0_0:
arglist = Jwlistcons(Jwlistcons(Jmakeint(1),Jwlistcons(Jmakeint(2),Jwlistcons(Jmakeint(3),Jwlistcons(Jmakeint(4),Jwlistcons(Jmakeint(5),Jwlistcons(Jmakeint(6),Jwlistcons(Jmakeint(7),Jwlistcons(Jmakeint(8),Jwlistcons(Jmakeint(9),NIL,th),th),th),th),th),th),th),th),th),Jwlistcons(varX,NIL,th),th);
Jpush_back(&&test1_0_1,arglist,np[Jget_scp(CONJ,th)][th],th);
...
test1_0_0_0join:
pointer = Jcons(varX,NIL);
Jpush_next(&&test1_0_0_1,pointer,th);
clause = Jget_choice(th);
goto queen_2;
test1_0_0_1:
Jpush_back(&&test1_0_0_0back,arglist,np[Jget_scp(CONJ,th)][th],th);
goto allfail;
}
test1_0_1:
Jpop_back(th);
...
Jpush_back(&&queen_2_1,arglist,np[Jget_scp(CONJ,th)][th],th);
goto queen_2_0_0join;
queen_2_0_0back:
pointer = next_stack1[np[Jget_scp(CONJ,th)][th]+1][th];
varData = Jnth(pointer,1);
varOut = Jnth(pointer,2);
queen_2_0_0join:
pointer = Jcons(varData,Jcons(varOut,NIL));
Jpush_next(&&queen_2_0_1,pointer,th);
clause = Jget_choice(th);
goto queen2_3;
queen_2_0_1:
goto success;
...
pointer = Jcons(varL1,Jcons(varH,Jcons(varT,Jcons(varHistory,Jcons(varQ,Jcons(varM,NIL))))));
Jpush_next(&&queen2_3_1_2,pointer,th);
...
queen2_3_1_2join:
pointer = Jcons(varL1,Jcons(varH,Jcons(varT,Jcons(varHistory,Jcons(varQ,Jcons(varM,NIL))))));
Jpush_next(&&queen2_3_1_3,pointer,th);
clause = Jget_choice(th);
goto queen2_3;
queen2_3_1_3:
goto success;
...
Jpush_next(&&qdelete_4_1_1,pointer,th);
clause = Jget_choice(th);
goto qdelete_4;
qdelete_4_1_1:
goto success;
