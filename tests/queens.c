...
varX = base - 1;
arglist = NIL;
Jpush_back(&&test16_0_1,arglist,vp[th],np[Jget_scp(CONJ,th)][th],th);
test16_0_0_1back:
Jpush_next(&&test16_0_0_2,th);
