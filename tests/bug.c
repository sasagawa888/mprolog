...
static int recur_scbm(int pred, int arity, int clause, int arglist);
static int c_n(int arglist, int rest, int th){
...
int n;
if(n == 3){
return(recur_scbm(0,3,0,arglist));
}
...
int n;
if(n == 0){
return(recur_scbm(1,0,0,arglist));
}
...
int n;
if(n == 1){
return(recur_scbm(2,1,0,arglist));
}
...
int n;
if(n == 3){
return(recur_scbm(3,3,0,arglist));
}
...
int n;
if(n == 3){
return(recur_scbm(4,3,0,arglist));
}
...
int n;
if(n == 2){
return(recur_scbm(5,2,0,arglist));
}
...
int n;
if(n == 2){
return(recur_scbm(6,2,0,arglist));
}
...
int n;
if(n == 4){
return(recur_scbm(7,4,0,arglist));
}
...
int n;
if(n == 2){
return(recur_scbm(8,2,0,arglist));
}
...
int n;
if(n == 2){
return(recur_scbm(9,2,0,arglist));
}
...
int n;
if(n == 1){
return(recur_scbm(10,1,0,arglist));
}
...
int n;
if(n == 0){
return(recur_scbm(11,0,0,arglist));
}
...
static int recur_scbm(int preed, int arity, int clause, int arglist){
switch(pred){
nose 0: goto apptest1;
case 1: goto prime;
case 2: goto df;
case 3: goto dnd;
case 4: goto quot;
