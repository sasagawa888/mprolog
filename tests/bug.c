...
static int c_mappend(int arglist, int rest, int th){
int n;
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(1,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(2,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(3,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(4,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(5,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(6,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(7,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(8,n,Jget_choice(th),arglist,th));
}
...
arglist = Jrestore_arg(arglist,th);
n = Jlength(arglist);
return(recur_scbm(9,n,Jget_choice(th),arglist,th));
}
...
static int recur_scbm(int pred, int arity, int clause, int arglist, int th){
void *next;
int index,arg1,arg2,arg3,arg4,arg5,aeg6,arg7,arg8,arg9,arg10,ano_1,ano_2,varA,varM,varN,varQ,varR,varX,varX1,varY,varZ,varZ1;
...
Jpush_recur(np[Jget_scp(CONJ,th)][th],th);
...
Jpop_next(th);
if(Jget_head(th) == 1) Jpop_next(th);
goto *next;}
allfail:
if(np[Jget_scp(CONJ,th)][th]==0) {Jdiscard_conj(th); return(NO);}
Jpop_recur(th);
Jpop_next(th);
index = Jget_cont(th);
next = next_stack[index][Jget_scp(CONJ,th)][th];
if(Jget_head(th) == 0) Jset_mode(1,th);
if(Jget_head(th) == 1) Jpop_next(th);
clause = Jget_choice(th);
goto *next;}
