...
static int c_woo(int arglist, int rest, int th);
...
printf("n->");Jprint(Jderef(arglist,th));if(n == 1){
arg1 = Jcar(arglist);
if(rest == NIL){
...
n = Jarity_count(arglist);
printf("bench->");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
...
n = Jarity_count(arglist);
printf("bench1->");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
case 0: goto clause_0_0;
...
printf("woo");Jprint(Jderef(arglist,th));if(n == 1){
arg1 = Jcar(arglist);
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
...
int arg_1_0_1 = Jwlistcons(varX,NIL,th);
Jpush_recur(th);
retry_1_0_1:;
if (c_woo(arg_1_0_1,NIL,th) == YES){
Jpop_recur(th);
return(YES);
}
}
...
case 2: goto clause_4_2;
case 10002: goto skip_4_2;
default: goto allfail;
}}
clause_4_0:
...
{
skip_4_0:;
if (Jcall_det(Jmakesys("<"),Jwlistcons(varX,Jwlistcons(varY,NIL,th),th),th) == YES){
int arg_4_0_1 = Jwlistcons(varL,Jwlistcons(varY,Jwlistcons(varL1,Jwlistcons(varL2,NIL,th),th),th),th);
Jpush_recur(th);
retry_4_0_1:;
if (c_partition(arg_4_0_1,NIL,th) == YES){
Jpop_recur(th);
return(YES);
}
}
...
{
skip_4_1:;
int arg_4_1_0 = Jwlistcons(varL,Jwlistcons(varY,Jwlistcons(varL1,Jwlistcons(varL2,NIL,th),th),th),th);
Jpush_recur(th);
retry_4_1_0:;
if (c_partition(arg_4_1_0,NIL,th) == YES){
Jpop_recur(th);
return(YES);
}
}
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("mmember");Jprint(Jderef(arglist,th));if(n == 2){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
if(rest == NIL){
clause = Jget_choice(th);
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("nat");Jprint(Jderef(arglist,th));if(n == 1){
arg1 = Jcar(arglist);
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("plus");Jprint(Jderef(arglist,th));if(n == 3){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
arg3 = Jnth(arglist,3);
if(rest == NIL){
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("times");Jprint(Jderef(arglist,th));if(n == 3){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
arg3 = Jnth(arglist,3);
if(rest == NIL){
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("le");Jprint(Jderef(arglist,th));if(n == 2){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
if(rest == NIL){
clause = Jget_choice(th);
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("lt");Jprint(Jderef(arglist,th));if(n == 2){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
if(rest == NIL){
clause = Jget_choice(th);
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("quot");Jprint(Jderef(arglist,th));if(n == 4){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
arg3 = Jnth(arglist,3);
arg4 = Jnth(arglist,4);
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("dnd");Jprint(Jderef(arglist,th));if(n == 2){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
if(rest == NIL){
clause = Jget_choice(th);
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("df");Jprint(Jderef(arglist,th));if(n == 2){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
if(rest == NIL){
clause = Jget_choice(th);
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("prime");Jprint(Jderef(arglist,th));if(n == 1){
arg1 = Jcar(arglist);
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("mappend");Jprint(Jderef(arglist,th));if(n == 3){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
arg3 = Jnth(arglist,3);
if(rest == NIL){
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("apptest");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
case 0: goto clause_0_0;
...
n = Jarity_count(arglist);
arglist = Jprepare(arglist,th);
printf("apptest1");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
case 0: goto clause_0_0;
...
n = Jarity_count(arglist);
printf("disj->");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
case 0: goto clause_0_0;
...
int n,body,save1,save2,save3,goal,cont,clause,res;
n = Jarity_count(arglist);
printf("disjtest->");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
case 0: goto clause_0_0;
...
int arg1,n,body,save1,save2,save3,goal,cont,clause,res;
n = Jarity_count(arglist);
printf("p->");Jprint(Jderef(arglist,th));if(n == 1){
arg1 = Jcar(arglist);
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
...
int arg1,varX,n,body,save1,save2,save3,goal,cont,clause,res;
n = Jarity_count(arglist);
printf("cut->");Jprint(Jderef(arglist,th));if(n == 1){
arg1 = Jcar(arglist);
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
...
n = Jarity_count(arglist);
printf("cuttest->");Jprint(Jderef(arglist,th));if(n == 0){
if(rest == NIL){
clause = Jget_choice(th);
switch(clause){
case 0: goto clause_0_0;
...
n = Jarity_count(arglist);
printf("f->");Jprint(Jderef(arglist,th));if(n == 2){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
if(rest == NIL){
clause = Jget_choice(th);
...
(deftpred)("woo",c_woo,1,6);
(deftpred)("partition",c_partition,4,6);
(deftpred)("mmember",c_mmember,2,6);
