...
arglist = Jpop_forward(arglist,th);
if(n == 3){
arg1 = Jcar(arglist);
arg2 = Jnth(arglist,2);
arg3 = Jnth(arglist,3);
...
Jpush_back(th);
retry_3_1_0:
int arg_3_1_0 = Jderef(Jwlistcons(varX,Jwlistcons(varY,Jwlistcons(varZ,NIL,th),th),th),th);
...
Jpush_back(th);
retry_1_1_0:
int arg_1_1_0 = Jderef(Jwlistcons(varX,NIL,th),th);
...
Jpush_back(th);
retry_3_1_0:
int arg_3_1_0 = Jderef(Jwlistcons(varX,Jwlistcons(varY,Jwlistcons(varZ1,NIL,th),th),th),th);
if (c_times(arg_3_1_0,NIL,th) == YES){
Jpush_back(th);
retry_3_1_1:
int arg_3_1_1 = Jderef(Jwlistcons(varZ1,Jwlistcons(varY,Jwlistcons(varZ,NIL,th),th),th),th);
...
Jpush_back(th);
retry_2_0_0:
int arg_2_0_0 = Jderef(Jwlistcons(varX,Jwlistcons(ano_1,Jwlistcons(varY,NIL,th),th),th),th);
...
Jpush_back(th);
retry_2_0_0:
int arg_2_0_0 = Jderef(Jwlistcons(Jwcons(Jmakepred("s"),Jwcons(varX,NIL,th),th),Jwlistcons(varY,NIL,th),th),th);
...
Jpush_back(th);
retry_4_0_0:
int arg_4_0_0 = Jderef(Jwlistcons(varX,Jwlistcons(varY,NIL,th),th),th);
Jprint(arg_4_0_0);
Jstepper();
...
Jpush_back(th);
retry_4_1_0:
int arg_4_1_0 = Jderef(Jwlistcons(varY,Jwlistcons(varX1,Jwlistcons(varX,NIL,th),th),th),th);
if (c_plus(arg_4_1_0,NIL,th) == YES){
Jpush_back(th);
retry_4_1_1:
int arg_4_1_1 = Jderef(Jwlistcons(varX1,Jwlistcons(varY,Jwlistcons(varQ,Jwlistcons(varR,NIL,th),th),th),th),th);
...
Jpush_back(th);
retry_2_0_0:
int arg_2_0_0 = Jderef(Jwlistcons(varN,Jwlistcons(varM,Jwlistcons(ano_2,Jwlistcons(Jwcons(Jmakepred("s"),Jwcons(ano_1,NIL,th),th),NIL,th),th),th),th),th);
...
Jpush_back(th);
retry_2_1_0:
int arg_2_1_0 = Jderef(Jwlistcons(Jwcons(Jmakepred("s"),Jwcons(Jwcons(Jmakepred("s"),Jwcons(varM,NIL,th),th),NIL,th),th),Jwlistcons(varN,NIL,th),th),th);
if (c_dnd(arg_2_1_0,NIL,th) == YES){
Jpush_back(th);
retry_2_1_1:
int arg_2_1_1 = Jderef(Jwlistcons(Jwcons(Jmakepred("s"),Jwcons(varM,NIL,th),th),Jwlistcons(varN,NIL,th),th),th);
...
Jpush_back(th);
retry_1_0_0:
int arg_1_0_0 = Jderef(Jwlistcons(varX,Jwlistcons(Jwcons(Jmakepred("s"),Jwcons(varX,NIL,th),th),NIL,th),th),th);
