...
int backstack[STACKSIZE][9][THREADSIZE];
//[0]sp, [1]choice, [2]wp, [3]ac, [4]disjunction, [5]choice-backup, [6]arglist-backup, [7]bias, [8]reuse
...
int fp[THREADSIZE];     // forward pointer
