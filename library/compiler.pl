...
gen_SCBM_function :-
    ...
    write('Spush_next(&&success,NIL,th);'),nl,
    gen_pred_switch,
    gen_SCBM_function1,
    gen_SCBM_function2,
    gen_SCBM_function3,
...
gen_back_debug(B,P) :-
    case([B==[] -> (write('printf("Spush_back next clause'),write(P),write('");'),nl),
          B==cut -> (write('printf("Spush_back allfail");'),nl),
          B==nil -> true
          | (write('printf("Spush_back before'),write(P),write('");'),nl)]).
