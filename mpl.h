...
enum { CAR_IDX, CDR_IDX, CADR_IDX, CADDR_IDX, CAAR_IDX, CADAR_IDX, PRINT_IDX,
       ...
       DISCARD_CONJ_IDX, PUSH_CONJ_IDX, POP_RECUR_IDX,
       GET_SUCC_IDX, GET_ARG_IDX,
       NUM_FN1S
};
...
enum { CONS_IDX, EQP_IDX, EQUALP_IDX, NUMEQP_IDX, SMALLERP_IDX, EQSMALLERP_IDX,
       ...
       SAVE_ARG_IDX, RESTORE_ARG_IDX,  PUSH_RECUR_IDX, 
       NUM_FN2S
};
...
enum {
    ...
    CHOICE_BACKUP_SCBM, ARGLIST_SCBM, SUCC_SCBM, 
    SCBM_ELT_SIZE,
};
